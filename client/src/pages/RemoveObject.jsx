        ...
        <div className='h-full overflow-y-scroll p-6 flex items-start gap-8 flex-wrap text-[#1F1F1F]'>
            ...
            <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 border border-gray-200 bg-white rounded-lg' >
                <div className='flex items-center gap-3'>
                    ...
                    <h1 className='text-xl font-semibold'>Background Object</h1>
                </div>
                ...
                <textarea rows={4} className='w-full p-2 px-4 mt-2 outline-none border border-gray-300 text-sm rounded-md'
                    type="text" placeholder='e.g., car in background, tree from the image' required value={prompt} onChange={(e) => setPrompt(e.target.value)} />


                <p className='mt-5 text-gray-500 text-xs font-light'  > Be specific about what you want to remove</p>
                <button type='submit' className='w-full flex items-center justify-center gap-2 mt-6 text-white px-4 py-2 rounded-lg text-sm cursor-pointer bg-gradient-to-r from-[#417DF6] to-[#8E37EB]'>
            ...
            <div class="w-full max-w-lg sm:max-w-xl p-4 bg-white rounded-lg flex flex-col border border-gray-200  min-h-[500px]">
                <div class="flex items-center gap-3">
                    <Scissors class="w-5 h-5 text-[#437AF5]" />
